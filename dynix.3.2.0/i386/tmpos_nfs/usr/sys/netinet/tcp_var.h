 ...
 * hereby transferred.
 */
#ifndef _NETINET_TCP_VAR_INCLUDED
#define _NETINET_TCP_VAR_INCLUDED

/*
 * $Header: tcp_var.h 2.6 1991/04/30 17:17:37 $
 */
...
#define	TF_ACTOPEN	0x20		/* did we start this connection?? */
...
#define	TCPOOB_HADDATA	0x02
	short	t_2mslval;		/* value to use for 2MSL timer */
};
...
struct	tcpstat {
	...
	u_long	tcps_sndctrl;		/* control (SYN|FIN) packets sent */
	u_long	tcps_sndrst;		/* RST packets sent */
...
extern	int	tcpcksumi;		/* 0 => no tcpcksum on input */
extern	int	tcpcksumo;		/* 0 => no tcpcksum on output */
extern  tcp_seq tcp_iss;		/* initial sequent # in tcp_subr.c */
#endif
#endif	/* _NETINET_TCP_VAR_INCLUDED */
