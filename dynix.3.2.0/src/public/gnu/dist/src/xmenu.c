...
/* $Source: /eng3/bruces7/djg/tmp/yuf_merge/v.new/rcs/src/public/gnu/dist/src/xmenu.c,v $
 * $Author: fubar $
 * $Locker:  $
 * $Header: xmenu.c 1.2 89/09/20 $
 *
 */

#ifndef lint
static char *rcsid_GXMenu_c = "$Header: xmenu.c 1.2 89/09/20 $";
#endif	lint
