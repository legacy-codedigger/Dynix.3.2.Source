...
/*
 *	$Source: /eng3/bruces7/djg/tmp/yuf_merge/v.new/rcs/src/public/gnu/dist/src/x11term.c,v $
 *	$Author: fubar $
 *	$Locker:  $
 *	$Header: x11term.c 1.1 89/09/20 $
 */

#ifndef lint
static char *rcsid_xterm_c = "$Header: x11term.c 1.1 89/09/20 $";
#endif	lint
