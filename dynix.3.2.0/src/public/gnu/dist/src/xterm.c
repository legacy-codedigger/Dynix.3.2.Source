...
/*
 *	$Source: /eng3/bruces7/djg/tmp/yuf_merge/v.new/rcs/src/public/gnu/dist/src/xterm.c,v $
 *	$Author: fubar $
 *	$Locker:  $
 *	$Header: xterm.c 1.3 89/09/20 $
 */

#ifndef lint
static char *rcsid_TrmXTERM_c = "$Header: xterm.c 1.3 89/09/20 $";
#endif	lint
