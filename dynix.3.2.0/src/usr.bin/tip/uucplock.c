...
#ifndef lint
static char rcsid[] = "$Header: uucplock.c 2.2 87/06/21 $";
#endif
	...
	time_t atime;
{
	...
	static int pid = -1;
	static char 
	    tempfile[sizeof("/usr/spool/uucp/LCK/LTMP.0123456789")];
