...
/*
 * Object module table for PC/SB address translation
 */
struct  mod {
	unsigned long sbase, lbase, pbase, resid;
};
...
struct	sym { 
	...
	/* unsigned char sym_type;		/* ddt doesn't use the type */
};
