...
\f2server process\fP.  These kernel facilities are described in
this section 1.
.PP
The facilities implemented in the kernel are those which define the
\f2UNIX virtual machine\fP which each process runs in.
...
\f2descriptors\fP.  Each descriptor resembles a device controller,
