...
/* $Header: pcc.h 1.6 1991/08/30 21:29:08 $ */
/*
 ...
 */
#ifdef ns32000
# define	PCCTM_PTR	0x10
# define	PCCTM_FTN	0x20
# define	PCCTM_ARY	0x30
# define	PCCTM_BASETYPE	0x0f
# define	PCCTM_TYPEMASK	0x30
# define	PCCTM_TYPESHIFT	2
# define	PCCTM_BASESHIFT	4
#else
# define	PCCTM_PTR	0x20
# define	PCCTM_FTN	0x40
# define	PCCTM_ARY	0x60
# define	PCCTM_BASETYPE	0x1f
# define	PCCTM_TYPEMASK	0x60
# define	PCCTM_TYPESHIFT	2
# define	PCCTM_BASESHIFT	5
#endif
...
#define INCREF(x) ((((x)&~PCCTM_BASETYPE)<<PCCTM_TYPESHIFT)|(PCCTM_PTR)|(x&PCCTM_BASETYPE))

#define DECREF(x) ((((x)>>PCCTM_TYPESHIFT)&~PCCTM_BASETYPE)|((x)&PCCTM_BASETYPE))
