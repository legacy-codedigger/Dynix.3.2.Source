...
#ident	"$Header: snmp_api.h 1.1 1991/07/31 00:06:08 $"

/*
 * snmp_api.h
 *	Definitions for the snmp API.
 */
 ...
 *     struct snmp_pdu *pdu;
 * 
 * Duplicates the pdu and any malloc'd data associated with it.
 */
struct snmp_pdu *snmp_dup_pdu();
...
/*
 * Time is seconds, set in init_snmp to be used for uptime calculations
 */
extern unsigned long StartTime;

/*
 * Linked list of traps receivers 
 */
struct traps {
    struct traps *next;
    struct snmp_session *session;
